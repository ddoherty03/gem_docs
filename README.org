...
- [[#installation][Installation]]
  ...
  - [[#update-your-rakefile][Update Your ~Rakefile~]]
- [[#usage][Usage]]
  - [[#generate-readmemd-from-readmeorg][Generate ~README.md~ from ~README.org~]]
  - [[#run-the-code-blocks-in-readmeorg][Run the Code Blocks in README.org]]
